...
class DataDistrictVisitsReportEntryGrid extends GroovyDataSource {

    DataDistrictVisitsReportEntryGrid() {
        DimensionBean d
        ...
        setBaseDetailsQuery('district_visits_reports dr')
    }
}
