...
class AgeGroups extends GroovyDataSource {
    ...
    AgeGroups() {
        ...
        init([id: 'AgeGroupId', sqlCol: 'description', sqlType: FieldType.TEXT, isResult: true,
                metaData: [grid: [width: 200]]])

        init([id: 'AgeGroup', sqlCol: 'description', sqlType: FieldType.TEXT, isResult: true,
                metaData: [grid: [width: 200]]])

        init([id: 'Min_Inclusive', sqlCol: 'min', sqlType: FieldType.INTEGER, isResult: true,
                metaData: [grid: [width: 200]]])

        init([id: 'Max_Inclusive', sqlCol: 'max', sqlType: FieldType.INTEGER, isResult: true,
                metaData: [grid: [width: 200]]])
