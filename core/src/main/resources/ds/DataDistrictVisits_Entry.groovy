...
class DataDistrictVisits_Entry extends GroovyOeDataEntrySource {
    ...
    DataDistrictVisits_Entry() {
        ...
        init([id: 'PatientId', sqlCol: 'patient_id', sqlType: FieldType.TEXT, isResult: true, isEdit: true,
                isFilter: true,
                metaData: [form: [allowBlank: false, width: 120]]])

        d = init([id: 'ReturnVisit', sqlCol: 'return_visit', sqlType: FieldType.BOOLEAN, isResult: true, isEdit: true,
                isFilter: true,
...
//        d.possibleValuesDsData = [[true, 'Yes'], [false, 'No']]
        ...
        init([id: 'Bp_Systolic', sqlCol: 'bp_systolic', sqlType: FieldType.DOUBLE, isResult: true, isEdit: true,
                isFilter: true,
                metaData: [form: [allowBlank: true, minValue: 0, maxValue: 200, allowDecimals: true, width: 100]]])

        init([id: 'Bp_Diastolic', sqlCol: 'bp_diastolic', sqlType: FieldType.DOUBLE, isResult: true, isEdit: true,
                isFilter: true,
                metaData: [form: [allowBlank: true, minValue: 0, maxValue: 200, allowDecimals: true, width: 100]]])
        ...
        init([id: 'Temperature', sqlCol: 'temperature', sqlType: FieldType.DOUBLE, isResult: true, isEdit: true,
                isFilter: true,
                metaData: [form: [allowBlank: true, minValue: 0, maxValue: 200, allowDecimals: true, width: 120]]])

        d = init([id: 'DiagnosesId', sqlCol: 'diagnoses_id', sqlType: FieldType.INTEGER, isEdit: true, isResult: true,
                isFilter: true, metaData: [form: [width: 200]]])
